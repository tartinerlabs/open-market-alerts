...
/**
 * GitHub mark icon. Provided locally because lucide-react removed brand icons
 * (including GitHub) in v1 for trademark reasons. Mirrors lucide's API: sizing
 * is driven by `className` (e.g. `size-6`) and color by `currentColor`.
 */
